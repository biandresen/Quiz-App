...
const Quiz = ({ setSeeResult, qList, setScore, resetQuiz }) => {
  ...
  return (
    <div className="relative flex text-center flex-col shadow-[0_0_20px_rgba(99,102,241,0.8)] bg-indigo-100 mx-auto px-3 py-6 md:px-10 md:py-8 mt-4 md:mt-10 rounded-xl w-[min(90%,700px)] h-[min(auto,700px)]">
      ...
      <h2 className="font-bold text-2xl md:text-4xl tracking-tight my-3 md:mt-7">
        Question {currentQuestion + 1}
      </h2>

      <h3 className="mt-3 md:mb-2 text-lg md:text-2xl tracking-tight">{qList[currentQuestion].question}</h3>
      ...
      <p className="mt-3 md:mt-8 text-[calc(1rem+0.5vw)] md:text-2xl">
      ...
      <div className="flex justify-between mt-auto pt-5">
        <button
          ...
          className="button text-[calc(1rem+0.5vw)] md:text-2xl if-disabled"
        ...
        {isDone ?
          <button
            ...
            className="button if-disabled text-[calc(1rem+0.5vw)] md:text-2xl"
